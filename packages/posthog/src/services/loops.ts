...
export interface LoopSkillBundleDTO {
  id: string;
  skill_name: string;
  skill_source: string;
  size: number;
...
export const LoopSkillBundleDTO = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    id: S.String,
    skill_name: S.String,
    skill_source: S.String,
    size: S.Number,
...
export const LoopDTOSkillBundlesList = /*@__PURE__*/ S.Array(
  LoopSkillBundleDTO,
) as any as S.Schema<LoopDTOSkillBundlesList>;
...
export interface LoopDTO {
  ...
  /** Skill bundles attached to this loop, seeded into every fired run. */
  skill_bundles: LoopDTOSkillBundlesList;
}
...
export const ListLoopsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    project_id: S.String.pipe(T.Label()),
    limit: S.optional(S.Number.pipe(T.Query())),
...
export const LoopSkillBundleUpload = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    file_name: S.String,
    skill_name: S.String,
...
export const UpdateLoopsSkillBundleRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    T.Http({
      method: "PUT",
      uri: "/api/projects/{project_id}/loops/{id}/skill_bundles/",
      code: 200,
    }),
  ),
).annotate({
...
export const createLoop: API.OperationMethod<
  CreateLoopRequest,
  LoopDTO,
  CreateLoopError,
  PosthogOpContext
...
export type ListLoopsError = PosthogOpError;
...
export const listLoops: API.OperationMethod<
  ListLoopsRequest,
  PaginatedLoopDTOList,
  ListLoopsError,
  PosthogOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: ListLoopsRequest,
