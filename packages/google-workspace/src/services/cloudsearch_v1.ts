...
export type GetIndexStatsError = NotFound | Forbidden | GoogleWorkspaceOpError;
...
export type GetQueryStatsError = NotFound | Forbidden | GoogleWorkspaceOpError;
...
export type GetUserStatsError = NotFound | Forbidden | GoogleWorkspaceOpError;
