...
export type GetFormsError = NotFound | Forbidden | GoogleWorkspaceOpError;
/** Get a form. */
...
export type GetFormsResponsesError =
  | NotFound
  | Forbidden
  | GoogleWorkspaceOpError;
...
export type ListFormsResponsesError =
  | NotFound
  | Forbidden
  | GoogleWorkspaceOpError;
...
export type ListFormsWatchesError =
  | NotFound
  | Forbidden
  | GoogleWorkspaceOpError;
