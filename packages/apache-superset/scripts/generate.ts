#!/usr/bin/env bun
/**
 * generate — turn the Smithy JSON model in .generated-specs into the Apache
 * Superset Effect SDK.
 *
 * Input:  .generated-specs/superset.json  (written by scripts/convert.ts)
 * Output: src/services/superset.ts  +  src/services/index.ts
 *
 * The smithy→SDK compiler and CLI pipeline live in
 * `@distilled.cloud/core/codegen`; this script is Apache Superset's provider
 * spec. Wire member names are kept on the TS surface, so no member renaming
 * or wire dictionaries appear here.
 */
...
/** Apache Superset's provider spec for the shared smithy→SDK compiler. */
const apacheSupersetSpec: SdkSpec = {
  ...
  operationDecl: {
    contextType: "ApacheSupersetOpContext",
    commonErrorType: "ApacheSupersetOpError",
    commonErrorClasses: ["UnknownApacheSupersetError"],
    protocol: "ApacheSupersetProtocol",
    retry: "Retry.Retry",
  },

  sourceNote: ".generated-specs (specs/spec-mirror-apache-superset)",
