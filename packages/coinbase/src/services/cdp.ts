// AUTO-GENERATED by scripts/generate.ts from .generated-specs (specs/spec-mirror-coinbase/specs/openapi.yaml). Do not edit.
...
export const EndUserEvmAccount = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    address: S.String,
    createdAt: S.String,
    exportedAt: S.optional(S.NullOr(S.String)),
    ejectedAt: S.optional(S.NullOr(S.String)),
  }),
).annotate({
...
export const OperationCustomerDisplay = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    referenceCode: S.optional(S.String),
  }),
).annotate({
  identifier: "OperationCustomerDisplay",
}) as any as S.Schema<OperationCustomerDisplay>;

export interface AuthorizeCoinbasePaymentSessionRequest {
  /** The unique identifier of the payment session to authorize via Coinbase. */
...
export const AuthorizeCoinbasePaymentSessionRequest = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      paymentSessionId: S.String.pipe(T.Label()),
      metadata: S.optional(Metadata),
      customerDisplay: S.optional(OperationCustomerDisplay),
      externalReferenceId: S.optional(S.String),
    }).pipe(
      T.Http({
        method: "POST",
        uri: "/v2/payment-sessions/{paymentSessionId}/authorizations/coinbase",
        code: 200,
      }),
    ),
).annotate({
  identifier: "AuthorizeCoinbasePaymentSessionRequest",
}) as any as S.Schema<AuthorizeCoinbasePaymentSessionRequest>;
...
export const PaymentError = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    code: S.optional(S.String),
    message: S.optional(S.String),
    occurredAt: S.optional(S.String),
  }),
).annotate({ identifier: "PaymentError" }) as any as S.Schema<PaymentError>;
...
export const PaymentSourceWallet = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    address: S.String,
    network: S.optional(PaymentSourceNetwork),
    asset: S.optional(S.String),
  }),
).annotate({
  identifier: "PaymentSourceWallet",
}) as any as S.Schema<PaymentSourceWallet>;
...
export const PaymentSourceCoinbase = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    coinbaseUserId: S.String,
  }),
).annotate({
  identifier: "PaymentSourceCoinbase",
}) as any as S.Schema<PaymentSourceCoinbase>;
...
export const OnchainTransaction = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    transactionHash: S.String,
    network: PaymentSourceNetwork,
  }),
).annotate({
  identifier: "OnchainTransaction",
}) as any as S.Schema<OnchainTransaction>;

/** The onchain transactions associated with this authorization. */
export type AuthorizationOnchainTransactionsList = Array<OnchainTransaction>;
export const AuthorizationOnchainTransactionsList = /*@__PURE__*/ S.Array(
  OnchainTransaction,
) as any as S.Schema<AuthorizationOnchainTransactionsList>;
...
export interface Authorization {
  ...
  /** The onchain transactions associated with this authorization. */
  onchainTransactions?: AuthorizationOnchainTransactionsList;
...
export const Authorization = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    paymentSessionId: S.optional(S.String),
    status: S.optional(PaymentActionStatus),
    amount: S.optional(S.String),
    error: S.optional(PaymentError),
    message: S.optional(S.String),
    metadata: S.optional(Metadata),
    externalReferenceId: S.optional(S.String),
    customerDisplay: S.optional(OperationCustomerDisplay),
    source: S.optional(PaymentSessionSource),
    onchainTransactions: S.optional(AuthorizationOnchainTransactionsList),
...
export const OnchainSignedPayload = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    payloadId: S.optional(S.String),
    signature: S.optional(S.String),
  }),
).annotate({
  identifier: "OnchainSignedPayload",
}) as any as S.Schema<OnchainSignedPayload>;

/** The processed payloads from the payer, corresponding to the payloads in the selected authorization option. */
export type AuthorizeWalletPaymentSessionRequestSignedPayloadsList =
  Array<OnchainSignedPayload>;
export const AuthorizeWalletPaymentSessionRequestSignedPayloadsList =
  /*@__PURE__*/ S.Array(
    OnchainSignedPayload,
  ) as any as S.Schema<AuthorizeWalletPaymentSessionRequestSignedPayloadsList>;

export interface AuthorizeWalletPaymentSessionRequest {
  ...
  optionId: string;
  /** The processed payloads from the payer, corresponding to the payloads in the selected authorization option. */
  signedPayloads: AuthorizeWalletPaymentSessionRequestSignedPayloadsList;
  metadata?: Metadata;
  /** Optional customer-facing display data for this authorization, shown to the payer. Falls back to the session's `orderCode` when `referenceCode` is omitted. */
  customerDisplay?: OperationCustomerDisplay;
...
export const AuthorizeWalletPaymentSessionRequest = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      paymentSessionId: S.String.pipe(T.Label()),
      optionId: S.String,
      ...
      T.Http({
        method: "POST",
        uri: "/v2/payment-sessions/{paymentSessionId}/authorizations/wallet",
        code: 200,
      }),
    ),
).annotate({
  identifier: "AuthorizeWalletPaymentSessionRequest",
}) as any as S.Schema<AuthorizeWalletPaymentSessionRequest>;

export interface AuthorizeX402PaymentSessionRequest {
  /** The unique identifier of the payment session to authorize with x402. */
  paymentSessionId: string;
}
export const AuthorizeX402PaymentSessionRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    paymentSessionId: S.String.pipe(T.Label()),
  }).pipe(
    T.Http({
      method: "POST",
      uri: "/v2/payment-sessions/{paymentSessionId}/authorizations/x402",
      code: 200,
    }),
  ),
).annotate({
  identifier: "AuthorizeX402PaymentSessionRequest",
}) as any as S.Schema<AuthorizeX402PaymentSessionRequest>;
...
export const CancelPaymentSessionRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    paymentSessionId: S.String.pipe(T.Label()),
    ...
    T.Http({
      method: "POST",
      uri: "/v2/payment-sessions/{paymentSessionId}/cancel",
      code: 200,
    }),
  ),
).annotate({
  identifier: "CancelPaymentSessionRequest",
}) as any as S.Schema<CancelPaymentSessionRequest>;
...
export interface PaymentTargetWallet {
  ...
  address: string;
  /** The blockchain network for the payment. */
  network?: PaymentTargetNetwork | (string & {});
}
export const PaymentTargetWallet = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    address: S.String,
    network: S.optional(PaymentTargetNetwork),
  }),
).annotate({
  identifier: "PaymentTargetWallet",
}) as any as S.Schema<PaymentTargetWallet>;
...
export const PaymentExpiries = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    authorizationExpiresAt: S.optional(S.String),
    captureExpiresAt: S.optional(S.String),
    refundExpiresAt: S.optional(S.String),
  }),
).annotate({
  identifier: "PaymentExpiries",
}) as any as S.Schema<PaymentExpiries>;
...
export const PaymentSessionBalances = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    capturable: S.optional(S.String),
    captured: S.optional(S.String),
    refundable: S.optional(S.String),
    refunded: S.optional(S.String),
  }),
).annotate({
  identifier: "PaymentSessionBalances",
}) as any as S.Schema<PaymentSessionBalances>;

/** The authorizations for this payment session. */
export type PaymentSessionAuthorizationsList = Array<Authorization>;
export const PaymentSessionAuthorizationsList = /*@__PURE__*/ S.Array(
  Authorization,
) as any as S.Schema<PaymentSessionAuthorizationsList>;

/** The onchain transactions associated with this capture. */
export type CaptureOnchainTransactionsList = Array<OnchainTransaction>;
export const CaptureOnchainTransactionsList = /*@__PURE__*/ S.Array(
  OnchainTransaction,
) as any as S.Schema<CaptureOnchainTransactionsList>;
...
export interface Capture {
  ...
  customerDisplay?: OperationCustomerDisplay;
  /** The onchain transactions associated with this capture. */
  onchainTransactions?: CaptureOnchainTransactionsList;
...
export const Capture = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    captureId: S.optional(S.String),
    paymentSessionId: S.optional(S.String),
    status: S.optional(PaymentActionStatus),
    amount: S.optional(S.String),
    finalCapture: S.Boolean,
    error: S.optional(PaymentError),
    metadata: S.optional(Metadata),
    externalReferenceId: S.optional(S.String),
    customerDisplay: S.optional(OperationCustomerDisplay),
    onchainTransactions: S.optional(CaptureOnchainTransactionsList),
    createdAt: S.optional(S.String),
    updatedAt: S.optional(S.String),
  }),
).annotate({ identifier: "Capture" }) as any as S.Schema<Capture>;

/** The captures for this payment session. */
export type PaymentSessionCapturesList = Array<Capture>;
export const PaymentSessionCapturesList = /*@__PURE__*/ S.Array(
  Capture,
) as any as S.Schema<PaymentSessionCapturesList>;

/** The onchain transactions associated with this void. */
export type VoidOnchainTransactionsList = Array<OnchainTransaction>;
export const VoidOnchainTransactionsList = /*@__PURE__*/ S.Array(
  OnchainTransaction,
) as any as S.Schema<VoidOnchainTransactionsList>;
...
export const Void = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    externalReferenceId: S.optional(S.String),
    customerDisplay: S.optional(OperationCustomerDisplay),
    onchainTransactions: S.optional(VoidOnchainTransactionsList),
    createdAt: S.optional(S.String),
    updatedAt: S.optional(S.String),
  }),
).annotate({ identifier: "Void" }) as any as S.Schema<Void>;

/** The voids for this payment session. */
export type PaymentSessionVoidsList = Array<Void>;
export const PaymentSessionVoidsList = /*@__PURE__*/ S.Array(
  Void,
) as any as S.Schema<PaymentSessionVoidsList>;
...
export const RefundWallet = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    address: S.String,
  }),
).annotate({ identifier: "RefundWallet" }) as any as S.Schema<RefundWallet>;
...
export const RefundOnchainTransactionsList = /*@__PURE__*/ S.Array(
  OnchainTransaction,
) as any as S.Schema<RefundOnchainTransactionsList>;
...
export interface Refund {
  ...
  customerDisplay?: OperationCustomerDisplay;
  /** The onchain transactions associated with this refund. */
  onchainTransactions?: RefundOnchainTransactionsList;
...
export const Refund = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    paymentSessionId: S.optional(S.String),
    source: S.optional(RefundSource),
    status: S.optional(PaymentActionStatus),
    amount: S.optional(S.String),
    ...
    externalReferenceId: S.optional(S.String),
    customerDisplay: S.optional(OperationCustomerDisplay),
    onchainTransactions: S.optional(RefundOnchainTransactionsList),
    createdAt: S.optional(S.String),
    updatedAt: S.optional(S.String),
  }),
...
export type PaymentSessionRefundsList = Array<Refund>;
export const PaymentSessionRefundsList = /*@__PURE__*/ S.Array(
  Refund,
) as any as S.Schema<PaymentSessionRefundsList>;
...
export const PaymentRedirect = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    failureUrl: S.optional(S.String),
    successUrl: S.optional(S.String),
  }),
).annotate({
  identifier: "PaymentRedirect",
}) as any as S.Schema<PaymentRedirect>;
...
export interface CustomerDisplayDisplayAmount {
  /** The display amount as a decimal string (e.g., `"1.37"`). */
  amount: string;
  /** An ISO 4217 currency code in lowercase for the display amount (e.g., `cad`, `usd`). */
  currency: string;
}
export const CustomerDisplayDisplayAmount = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    amount: S.String,
    currency: S.String,
  }),
).annotate({
  identifier: "CustomerDisplayDisplayAmount",
}) as any as S.Schema<CustomerDisplayDisplayAmount>;
...
export const CustomerDisplay = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    merchantName: S.optional(S.String),
    displayAmount: S.optional(CustomerDisplayDisplayAmount),
    orderCode: S.optional(S.String),
  }),
).annotate({
  identifier: "CustomerDisplay",
}) as any as S.Schema<CustomerDisplay>;
...
export interface PaymentSession {
  ...
  /** The authorizations for this payment session. */
  authorizations?: PaymentSessionAuthorizationsList;
  /** The captures for this payment session. */
  captures?: PaymentSessionCapturesList;
  /** The voids for this payment session. */
  voids?: PaymentSessionVoidsList;
  /** The refunds for this payment session. */
  refunds?: PaymentSessionRefundsList;
...
export const PaymentSession = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    amount: S.optional(S.String),
    asset: S.optional(S.String),
    target: S.optional(PaymentSessionTarget),
    autoCapture: S.optional(S.Boolean),
    expiries: S.optional(PaymentExpiries),
    source: S.optional(PaymentSessionSource),
    status: S.optional(PaymentSessionStatus),
    balances: S.optional(PaymentSessionBalances),
    authorizations: S.optional(PaymentSessionAuthorizationsList),
    captures: S.optional(PaymentSessionCapturesList),
    voids: S.optional(PaymentSessionVoidsList),
    refunds: S.optional(PaymentSessionRefundsList),
    url: S.optional(S.String),
    x402Url: S.optional(S.String),
    redirect: S.optional(PaymentRedirect),
    customerDisplay: S.optional(CustomerDisplay),
    metadata: S.optional(Metadata),
    externalReferenceId: S.optional(S.String),
    cancellationReason: S.optional(S.String),
    createdAt: S.optional(S.String),
...
export const CapturePaymentSessionRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    paymentSessionId: S.String.pipe(T.Label()),
    amount: S.optional(S.String),
    finalCapture: S.Boolean,
    ...
    T.Http({
      method: "POST",
      uri: "/v2/payment-sessions/{paymentSessionId}/captures",
      code: 200,
    }),
  ),
).annotate({
  identifier: "CapturePaymentSessionRequest",
}) as any as S.Schema<CapturePaymentSessionRequest>;
...
export const CapabilityInput = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    requested: S.Boolean,
  }),
).annotate({
  identifier: "CapabilityInput",
}) as any as S.Schema<CapabilityInput>;
...
export const CapabilitiesMapInput = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    custodyCrypto: S.optional(CapabilityInput),
    custodyFiat: S.optional(CapabilityInput),
    custodyStablecoin: S.optional(CapabilityInput),
    tradeCrypto: S.optional(CapabilityInput),
    tradeStablecoin: S.optional(CapabilityInput),
    transferCrypto: S.optional(CapabilityInput),
    transferFiat: S.optional(CapabilityInput),
    transferStablecoin: S.optional(CapabilityInput),
  }),
).annotate({
  identifier: "CapabilitiesMapInput",
}) as any as S.Schema<CapabilitiesMapInput>;

/** Primary residential address. Only US addresses are currently supported. Non-US `countryCode` values are rejected with a 400. */
export interface IndividualInputAddress {
...
export const IndividualInputAddress = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
  ...
  identifier: "IndividualInputAddress",
}) as any as S.Schema<IndividualInputAddress>;

/** Date of birth with lenient formatting. Accepts both zero-padded ("04", "07") and single-digit ("4", "7") values for day and month. */
...
export const DateOfBirthLenient = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
  ...
  identifier: "DateOfBirthLenient",
}) as any as S.Schema<DateOfBirthLenient>;
...
export interface IndividualInput {
  ...
  phoneNumber?: string;
  /** Primary purpose for using Coinbase services. */
  purposeOfAccount?: IndividualInputPurposeOfAccount | (string & {});
  /** Primary source of funds for the account. */
  sourceOfFunds?: IndividualInputSourceOfFunds | (string & {});
  /** Current employment status. */
  employmentStatus?: IndividualInputEmploymentStatus | (string & {});
  /** Industry or occupation. */
  occupation?: IndividualInputOccupation | (string & {});
  /** Expected annual volume of activity on the account, expressed as a dollar range. Use the dollar-honest ids below: - `under_1k`: $0 – $1,000 - `1k_to_10k`: $1,000 – $10,000 - `10k_to_100k`: $10,000 – $100,000 - `100k_to_250k`: $100,000 – $250,000 - `250k_to_750k`: $250,000 – $750,000 - `750k_to_1_5m`: $750,000 – $1.5M - `1_5m_plus`: $1.5M+ */
  expectedVolume?: IndividualInputExpectedVolume | (string & {});
}
export const IndividualInput = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    firstName: S.optional(S.String),
    lastName: S.optional(S.String),
    address: S.optional(IndividualInputAddress),
    ssnLast4: S.optional(S.String),
    dateOfBirth: S.optional(DateOfBirthLenient),
    fullSsn: S.optional(S.String),
    citizenship: S.optional(S.String),
    email: S.optional(S.String),
    phoneNumber: S.optional(S.String),
    purposeOfAccount: S.optional(IndividualInputPurposeOfAccount),
    sourceOfFunds: S.optional(IndividualInputSourceOfFunds),
    employmentStatus: S.optional(IndividualInputEmploymentStatus),
    occupation: S.optional(IndividualInputOccupation),
    expectedVolume: S.optional(IndividualInputExpectedVolume),
  }),
).annotate({
  identifier: "IndividualInput",
}) as any as S.Schema<IndividualInput>;

/** The project IDs that this customer is associated with. */
export type CreateCustomerRequestProjectIdsList = Array<string>;
export const CreateCustomerRequestProjectIdsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<CreateCustomerRequestProjectIdsList>;
...
export type CreateCustomerRequestTosAcceptancesList = Array<TosAcceptance>;
export const CreateCustomerRequestTosAcceptancesList = /*@__PURE__*/ S.Array(
  TosAcceptance,
) as any as S.Schema<CreateCustomerRequestTosAcceptancesList>;
...
export interface UsW9Attestation {
  /** The tax form being attested to, as listed in `Customer.requirements.taxAttestation.taxForms[]`. Must be `us_w9` for this variant. */
  form: UsW9AttestationForm | (string & {});
...
export const UsW9Attestation = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    form: UsW9AttestationForm,
    edeliveryConsent: S.Boolean,
    acceptedAt: S.String,
    isExemptBackupWithholding: S.Boolean,
  }),
).annotate({
  identifier: "UsW9Attestation",
}) as any as S.Schema<UsW9Attestation>;
...
export type CreateCustomerRequestTaxAttestationsList = Array<UsW9Attestation>;
export const CreateCustomerRequestTaxAttestationsList = /*@__PURE__*/ S.Array(
  UsW9Attestation,
) as any as S.Schema<CreateCustomerRequestTaxAttestationsList>;
...
export const Compliance = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    requesterIpAddress: S.optional(S.String),
  }),
...
export interface CreateCustomerRequest {
  ...
  /** The project IDs that this customer is associated with. */
  projectIds?: CreateCustomerRequestProjectIdsList;
  /** Terms of Service acceptances to record on the customer. Submit one entry per required version surfaced inline on `requirements.tos.tosVersions[]` (returned by `Get Customer`, `Create Customer`, and `Update Customer` whenever a `tos` requirement is unsatisfied). The server rejects each acceptance whose `language` is not listed under `languages` on the matching required version with `errorType: "unsupported_tos_language"`. When new required Terms of Service versions are published, only the new `versionId`s appear in `requirements.tos.tosVersions[]`; submit acceptances for only those new version(s). Omit `tosAcceptances` on a partial update to leave previously recorded acceptances unchanged. Sending `tosAcceptances: []` is invalid (`errorType: "invalid_request"`) because it would clear all acceptances without replacing them; omit the field entirely when you are not updating Terms of Service acceptances. */
  tosAcceptances?: CreateCustomerRequestTosAcceptancesList;
  /** Tax attestations to record on the customer. Submit one entry per required form surfaced inline on `requirements.taxAttestation.taxForms[]` (returned by `Get Customer`, `Create Customer`, and `Update Customer` whenever a `taxAttestation` requirement is unsatisfied). The required fields per entry depend on `form`; see `TaxAttestation`. This field is ingestion-only and is never returned on read. Omit `taxAttestations` on a partial update to leave previously recorded attestations unchanged. Sending `taxAttestations: []` is invalid (`errorType: "invalid_request"`) because it would clear all attestations without replacing them; omit the field entirely when you are not updating tax attestations. */
  taxAttestations?: CreateCustomerRequestTaxAttestationsList;
  compliance?: Compliance;
}
export const CreateCustomerRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    type: CustomerType,
    capabilities: S.optional(CapabilitiesMapInput),
    individual: S.optional(IndividualInput),
    projectIds: S.optional(CreateCustomerRequestProjectIdsList),
    tosAcceptances: S.optional(CreateCustomerRequestTosAcceptancesList),
    taxAttestations: S.optional(CreateCustomerRequestTaxAttestationsList),
    compliance: S.optional(Compliance),
  }).pipe(T.Http({ method: "POST", uri: "/v2/customers", code: 200 })),
).annotate({
...
export const CapabilitiesMap = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    custodyCrypto: S.optional(Capability),
    custodyFiat: S.optional(Capability),
    custodyStablecoin: S.optional(Capability),
    tradeCrypto: S.optional(Capability),
    tradeStablecoin: S.optional(Capability),
    transferCrypto: S.optional(Capability),
    transferFiat: S.optional(Capability),
    transferStablecoin: S.optional(Capability),
  }),
).annotate({
...
export const RequirementImpactList = /*@__PURE__*/ S.Array(
  CapabilityName,
) as any as S.Schema<RequirementImpactList>;
...
export type TermsOfServiceLanguagesList = Array<string>;
export const TermsOfServiceLanguagesList = /*@__PURE__*/ S.Array(
  S.String,
...
export const RequirementTosVersionsList = /*@__PURE__*/ S.Array(
  TermsOfService,
) as any as S.Schema<RequirementTosVersionsList>;
...
export const RequirementTaxFormsList = /*@__PURE__*/ S.Array(
  TaxForm,
) as any as S.Schema<RequirementTaxFormsList>;
...
export const Requirement = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    status: RequirementStatus,
    deadline: S.optional(S.String),
    impact: S.optional(RequirementImpactList),
    tosVersions: S.optional(RequirementTosVersionsList),
    taxForms: S.optional(RequirementTaxFormsList),
  }),
...
export const RequirementsMap = /*@__PURE__*/ S.Record(
  S.String,
  Requirement,
) as any as S.Schema<RequirementsMap>;
...
export const Individual = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    firstName: S.optional(S.String),
    lastName: S.optional(S.String),
    email: S.optional(S.String),
  }),
).annotate({ identifier: "Individual" }) as any as S.Schema<Individual>;

/** The project IDs that this customer is associated with. */
export type CustomerProjectIdsList = Array<string>;
export const CustomerProjectIdsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<CustomerProjectIdsList>;

/** Terms of Service acceptances recorded for the customer. */
export type CustomerTosAcceptancesList = Array<TosAcceptance>;
export const CustomerTosAcceptancesList = /*@__PURE__*/ S.Array(
  TosAcceptance,
) as any as S.Schema<CustomerTosAcceptancesList>;
...
export interface Customer {
  ...
  /** The project IDs that this customer is associated with. */
  projectIds?: CustomerProjectIdsList;
  /** Terms of Service acceptances recorded for the customer. */
  tosAcceptances?: CustomerTosAcceptancesList;
}
export const Customer = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    createdAt: S.optional(S.String),
    updatedAt: S.optional(S.String),
    individual: S.optional(Individual),
    projectIds: S.optional(CustomerProjectIdsList),
    tosAcceptances: S.optional(CustomerTosAcceptancesList),
  }),
...
export const CreateCryptoDepositDestinationRequest = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      accountId: S.String,
      type: DepositDestinationType,
      target: S.optional(DepositDestinationTarget),
      metadata: S.optional(Metadata),
      compliance: S.optional(Compliance),
      crypto: CreateDepositDestinationCrypto,
    }),
...
export interface CreateDepositDestinationFiat {
  /** The fiat currency for the deposit destination. */
  currency: CreateDepositDestinationFiatCurrency | (string & {});
  ...
  paymentRail?: DepositDestinationPaymentRail | (string & {});
}
export const CreateDepositDestinationFiat = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    currency: CreateDepositDestinationFiatCurrency,
    paymentRail: S.optional(DepositDestinationPaymentRail),
  }),
).annotate({
  identifier: "CreateDepositDestinationFiat",
}) as any as S.Schema<CreateDepositDestinationFiat>;

export interface CreateFiatDepositDestinationRequest {
  /** The ID of the Account, which is a UUID prefixed by the string `account_`, that owns the deposit destination. */
  accountId: string;
  type: DepositDestinationType;
  target?: DepositDestinationTarget;
...
export const CreateFiatDepositDestinationRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    accountId: S.String,
    type: DepositDestinationType,
    target: S.optional(DepositDestinationTarget),
  ...
  identifier: "CreateFiatDepositDestinationRequest",
}) as any as S.Schema<CreateFiatDepositDestinationRequest>;
...
export const CreateDepositDestinationRequest2 = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    body: CreateDepositDestinationRequest.pipe(T.HttpBody()),
  }).pipe(
    T.Http({ method: "POST", uri: "/v2/deposit-destinations", code: 200 }),
  ),
).annotate({
  identifier: "CreateDepositDestinationRequest2",
}) as any as S.Schema<CreateDepositDestinationRequest2>;
...
export type BankAccountUSSupportedRailsList =
  Array<DepositDestinationPaymentRail>;
export const BankAccountUSSupportedRailsList = /*@__PURE__*/ S.Array(
  DepositDestinationPaymentRail,
) as any as S.Schema<BankAccountUSSupportedRailsList>;
...
export interface BankAccountUS {
  ...
  referenceCode?: string;
  /** The payment rails this account can receive deposits on. */
  supportedRails: BankAccountUSSupportedRailsList;
}
export const BankAccountUS = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    accountType: BankAccountUSAccountType,
    currency: BankAccountUSCurrency,
    bankName: S.String,
    beneficiaryName: S.String,
    routingNumber: S.String,
    accountNumber: S.String,
    bankAddress: S.optional(S.String),
    referenceCode: S.optional(S.String),
    supportedRails: BankAccountUSSupportedRailsList,
  }),
).annotate({ identifier: "BankAccountUS" }) as any as S.Schema<BankAccountUS>;
...
export const FiatDepositDestination = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    depositDestinationId: S.String,
    accountId: S.String,
    type: FiatDepositDestinationType,
  ...
  identifier: "FiatDepositDestination",
}) as any as S.Schema<FiatDepositDestination>;
...
export const DisbursementCoinbaseTarget = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    coinbaseUserId: S.String,
  }),
).annotate({
  identifier: "DisbursementCoinbaseTarget",
}) as any as S.Schema<DisbursementCoinbaseTarget>;
...
export const DisbursementWalletTarget = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    address: S.String,
    network: Network,
  }),
).annotate({
  identifier: "DisbursementWalletTarget",
}) as any as S.Schema<DisbursementWalletTarget>;

/** The target of the disbursement. Can be either a Coinbase user account or an onchain blockchain address. */
export type DisbursementTarget =
...
export const PhysicalAddress = IndividualInputAddress;
...
export interface DisbursementCompliance {
  /** IPv4 or IPv6 address of the individual (i.e., end-customer) that initiated this request. NOT the IP of the partner server making the API call. */
  requesterIpAddress?: string;
...
export const DisbursementCompliance = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    requesterIpAddress: S.optional(S.String),
    recipient: S.optional(Person),
  }),
).annotate({
  identifier: "DisbursementCompliance",
}) as any as S.Schema<DisbursementCompliance>;

export interface CreateDisbursementRequest {
  /** The source from which to fund the disbursement. */
  source: TransfersAccount;
...
export const CreateDisbursementRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    source: TransfersAccount,
    target: DisbursementTarget,
    amount: S.String,
    ...
    customerDisplay: S.optional(OperationCustomerDisplay),
    metadata: S.optional(Metadata),
    compliance: S.optional(DisbursementCompliance),
  }).pipe(T.Http({ method: "POST", uri: "/v2/disbursements", code: 200 })),
).annotate({
  identifier: "CreateDisbursementRequest",
}) as any as S.Schema<CreateDisbursementRequest>;

/** The onchain transactions associated with this disbursement. */
export type DisbursementOnchainTransactionsList = Array<OnchainTransaction>;
export const DisbursementOnchainTransactionsList = /*@__PURE__*/ S.Array(
  OnchainTransaction,
) as any as S.Schema<DisbursementOnchainTransactionsList>;
...
export interface Disbursement {
  ...
  error?: PaymentError;
  /** The onchain transactions associated with this disbursement. */
  onchainTransactions?: DisbursementOnchainTransactionsList;
...
export const Disbursement = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    disbursementId: S.String,
    source: TransfersAccount,
    target: DisbursementTarget,
    amount: S.String,
    asset: S.String,
    ...
    metadata: S.optional(Metadata),
    error: S.optional(PaymentError),
    onchainTransactions: S.optional(DisbursementOnchainTransactionsList),
    createdAt: S.String,
    updatedAt: S.String,
  }),
).annotate({ identifier: "Disbursement" }) as any as S.Schema<Disbursement>;
...
export const SwapPermit2Approval = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    hash: S.String,
    eip712: EIP712Message,
  }),
).annotate({
  identifier: "SwapPermit2Approval",
}) as any as S.Schema<SwapPermit2Approval>;
...
export const CommonSwapResponseIssuesAllowance = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    currentAllowance: S.String,
    spender: S.String,
  }),
).annotate({
  identifier: "CommonSwapResponseIssuesAllowance",
}) as any as S.Schema<CommonSwapResponseIssuesAllowance>;
...
export const CommonSwapResponseIssuesBalance = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    token: S.String,
  ...
  identifier: "CommonSwapResponseIssuesBalance",
}) as any as S.Schema<CommonSwapResponseIssuesBalance>;
...
export const CreateSwapQuoteResponseIssues = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    allowance: S.NullOr(CommonSwapResponseIssuesAllowance),
    balance: S.NullOr(CommonSwapResponseIssuesBalance),
...
export interface CreateSwapQuoteResponse {
  ...
  permit2: SwapPermit2Approval | null;
  /** The details of the transaction to be signed and submitted to execute the swap. */
...
export const CreateSwapQuoteResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    permit2: S.NullOr(SwapPermit2Approval),
    transaction: CreateSwapQuoteResponseTransaction,
...
export const CreateOnrampOrderRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    agreementAcceptedAt: S.optional(S.String),
    ...
    phoneNumber: S.optional(S.String),
    phoneNumberVerifiedAt: S.optional(S.String),
    ...
    userAuthToken: S.optional(S.String),
...
export type OnrampOrderStatus =
  ...
  | "ONRAMP_ORDER_STATUS_PENDING_VERIFICATION"
...
export interface PaymentSessionCompliance {
  /** IPv4 or IPv6 address of the individual (i.e., end-customer) that initiated this request. NOT the IP of the partner server making the API call. */
  requesterIpAddress?: string;
...
export const PaymentSessionCompliance = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    requesterIpAddress: S.optional(S.String),
    buyer: S.optional(Person),
  }),
).annotate({
  identifier: "PaymentSessionCompliance",
}) as any as S.Schema<PaymentSessionCompliance>;
...
export const CreatePaymentSessionRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    customerDisplay: S.optional(CustomerDisplay),
    metadata: S.optional(Metadata),
    compliance: S.optional(PaymentSessionCompliance),
  }).pipe(T.Http({ method: "POST", uri: "/v2/payment-sessions", code: 200 })),
).annotate({
...
export const TravelRule = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    attestVerifiedWalletOwnership: S.optional(S.Boolean),
...
export const AchDepositSource = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    currency: S.String,
    companyName: S.String,
    companyEntryDescription: S.String,
    individualIdentificationNumber: S.optional(S.String),
  }),
).annotate({
  identifier: "AchDepositSource",
}) as any as S.Schema<AchDepositSource>;
...
export type FedwireDepositSourceOriginatorToBeneficiaryList = Array<string>;
export const FedwireDepositSourceOriginatorToBeneficiaryList =
  /*@__PURE__*/ S.Array(
    S.String,
  ) as any as S.Schema<FedwireDepositSourceOriginatorToBeneficiaryList>;
...
export interface FedwireDepositSource {
  ...
  /** The Originator to Beneficiary Information (OBI) lines from the Fedwire message. Up to 4 lines, each up to 35 characters. Free-form and may contain identifying information about the originator. Masked on webhook payloads. */
  originatorToBeneficiary?: FedwireDepositSourceOriginatorToBeneficiaryList;
}
export const FedwireDepositSource = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    currency: S.String,
    omad: S.String,
    accountNumber: S.String,
    originatorName: S.String,
    originatorToBeneficiary: S.optional(
      FedwireDepositSourceOriginatorToBeneficiaryList,
    ),
  }),
).annotate({
  identifier: "FedwireDepositSource",
}) as any as S.Schema<FedwireDepositSource>;
...
export const GetDisbursementRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    disbursementId: S.String.pipe(T.Label()),
  }).pipe(
    T.Http({
      method: "GET",
      uri: "/v2/disbursements/{disbursementId}",
      code: 200,
    }),
  ),
).annotate({
  identifier: "GetDisbursementRequest",
}) as any as S.Schema<GetDisbursementRequest>;
...
export type OnrampLimitUpgradeOptionFieldsList =
  Array<OnrampLimitUpgradeIdentityFieldKey>;
export const OnrampLimitUpgradeOptionFieldsList = /*@__PURE__*/ S.Array(
  OnrampLimitUpgradeIdentityFieldKey,
) as any as S.Schema<OnrampLimitUpgradeOptionFieldsList>;
...
export const OnrampLimitUpgrade = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    limitType: OnrampLimitType,
    maxUpgrade: S.String,
  }),
).annotate({
  identifier: "OnrampLimitUpgrade",
}) as any as S.Schema<OnrampLimitUpgrade>;

/** The limit values associated with this upgrade. */
export type OnrampLimitUpgradeOptionLimitUpgradesList =
  Array<OnrampLimitUpgrade>;
export const OnrampLimitUpgradeOptionLimitUpgradesList = /*@__PURE__*/ S.Array(
  OnrampLimitUpgrade,
) as any as S.Schema<OnrampLimitUpgradeOptionLimitUpgradesList>;
...
export interface OnrampLimitUpgradeOption {
  ...
  /** The identity fields associated with the current status. Contains fields to submit for `unrequested` and `resubmit`, fields pending review for `pending`, and is empty for `active` and `inactive`. */
  fields: OnrampLimitUpgradeOptionFieldsList;
  /** The limit values associated with this upgrade. */
  limitUpgrades: OnrampLimitUpgradeOptionLimitUpgradesList;
}
export const OnrampLimitUpgradeOption = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    status: OnrampLimitUpgradeStatus,
    fields: OnrampLimitUpgradeOptionFieldsList,
    limitUpgrades: OnrampLimitUpgradeOptionLimitUpgradesList,
  ...
  identifier: "OnrampLimitUpgradeOption",
}) as any as S.Schema<OnrampLimitUpgradeOption>;
...
export type GetOnrampUserLimitsResponseLimitUpgradeOptionsList =
  Array<OnrampLimitUpgradeOption>;
export const GetOnrampUserLimitsResponseLimitUpgradeOptionsList =
  /*@__PURE__*/ S.Array(
    OnrampLimitUpgradeOption,
  ) as any as S.Schema<GetOnrampUserLimitsResponseLimitUpgradeOptionsList>;

export interface GetOnrampUserLimitsResponse {
  /** The list of limits applicable to the user. */
  limits: GetOnrampUserLimitsResponseLimitsList;
  /** The user's limit upgrade status and associated upgrade details. Omitted when limit upgrades are not available for the calling app or user. Use the [Request Limit Upgrade](https://docs.cdp.coinbase.com/api-reference/v2/rest-api/onramp/request-limits-upgrade) endpoint to request a limit upgrade. */
  limitUpgradeOptions?: GetOnrampUserLimitsResponseLimitUpgradeOptionsList;
}
export const GetOnrampUserLimitsResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    limits: GetOnrampUserLimitsResponseLimitsList,
    limitUpgradeOptions: S.optional(
      GetOnrampUserLimitsResponseLimitUpgradeOptionsList,
    ),
  }),
).annotate({
...
export const GetPaymentSessionRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    T.Http({
      method: "GET",
      uri: "/v2/payment-sessions/{paymentSessionId}",
      code: 200,
    }),
  ),
).annotate({
...
export interface GetPaymentSessionAuthorizationRequest {
  /** The unique identifier of the payment session. */
  paymentSessionId: string;
  /** The unique identifier of the authorization. */
  authorizationId: string;
}
export const GetPaymentSessionAuthorizationRequest = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      paymentSessionId: S.String.pipe(T.Label()),
      ...
      T.Http({
        method: "GET",
        uri: "/v2/payment-sessions/{paymentSessionId}/authorizations/{authorizationId}",
        code: 200,
      }),
    ),
).annotate({
  identifier: "GetPaymentSessionAuthorizationRequest",
}) as any as S.Schema<GetPaymentSessionAuthorizationRequest>;

export interface GetPaymentSessionCaptureRequest {
  /** The unique identifier of the payment session. */
  paymentSessionId: string;
  /** The unique identifier of the capture. */
  captureId: string;
}
export const GetPaymentSessionCaptureRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    paymentSessionId: S.String.pipe(T.Label()),
    captureId: S.String.pipe(T.Label()),
  }).pipe(
    T.Http({
      method: "GET",
      uri: "/v2/payment-sessions/{paymentSessionId}/captures/{captureId}",
      code: 200,
    }),
  ),
).annotate({
  identifier: "GetPaymentSessionCaptureRequest",
}) as any as S.Schema<GetPaymentSessionCaptureRequest>;

export interface GetPaymentSessionRefundRequest {
  /** The unique identifier of the payment session. */
  paymentSessionId: string;
  /** The unique identifier of the refund. */
  refundId: string;
}
export const GetPaymentSessionRefundRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    paymentSessionId: S.String.pipe(T.Label()),
    ...
    T.Http({
      method: "GET",
      uri: "/v2/payment-sessions/{paymentSessionId}/refunds/{refundId}",
      code: 200,
    }),
  ),
).annotate({
  identifier: "GetPaymentSessionRefundRequest",
}) as any as S.Schema<GetPaymentSessionRefundRequest>;

export interface GetPaymentSessionVoidRequest {
  /** The unique identifier of the payment session. */
  paymentSessionId: string;
  /** The unique identifier of the void. */
  voidId: string;
}
export const GetPaymentSessionVoidRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    paymentSessionId: S.String.pipe(T.Label()),
    voidId: S.String.pipe(T.Label()),
  }).pipe(
    T.Http({
      method: "GET",
      uri: "/v2/payment-sessions/{paymentSessionId}/voids/{voidId}",
      code: 200,
    }),
  ),
).annotate({
  identifier: "GetPaymentSessionVoidRequest",
}) as any as S.Schema<GetPaymentSessionVoidRequest>;
...
export type GetWalletAuthorizationOptionsRequestAddressesList = Array<string>;
export const GetWalletAuthorizationOptionsRequestAddressesList =
  /*@__PURE__*/ S.Array(
    S.String,
  ) as any as S.Schema<GetWalletAuthorizationOptionsRequestAddressesList>;

export interface GetWalletAuthorizationOptionsRequest {
  /** The unique identifier of the payment session. */
  paymentSessionId: string;
  ...
  addresses: GetWalletAuthorizationOptionsRequestAddressesList;
  /** Optional filter to restrict options to a specific blockchain network. */
  network?: PaymentSourceNetwork | (string & {});
  /** Optional filter to restrict options to a specific asset. */
  asset?: string;
}
export const GetWalletAuthorizationOptionsRequest = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      paymentSessionId: S.String.pipe(T.Label()),
      addresses: GetWalletAuthorizationOptionsRequestAddressesList.pipe(
        T.Query(),
      ),
      network: S.optional(PaymentSourceNetwork.pipe(T.Query())),
      asset: S.optional(S.String.pipe(T.Query())),
    }).pipe(
      T.Http({
        method: "GET",
        uri: "/v2/payment-sessions/{paymentSessionId}/authorizations/wallet/options",
        code: 200,
      }),
    ),
).annotate({
  identifier: "GetWalletAuthorizationOptionsRequest",
}) as any as S.Schema<GetWalletAuthorizationOptionsRequest>;
...
export const EIP3009Payload = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    payloadId: S.String,
    type: EIP3009PayloadType,
    data: EIP712Message,
  }),
).annotate({ identifier: "EIP3009Payload" }) as any as S.Schema<EIP3009Payload>;
...
export const Permit2Payload = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    payloadId: S.String,
    type: Permit2PayloadType,
    data: EIP712Message,
  }),
).annotate({ identifier: "Permit2Payload" }) as any as S.Schema<Permit2Payload>;
...
export const Erc20ApprovalPayloadData = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    chainId: S.Number,
    to: S.String,
    data: S.String,
  ...
  identifier: "Erc20ApprovalPayloadData",
}) as any as S.Schema<Erc20ApprovalPayloadData>;
...
export const Erc20ApprovalPayload = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    payloadId: S.String,
    type: Erc20ApprovalPayloadType,
    data: Erc20ApprovalPayloadData,
  ...
  identifier: "Erc20ApprovalPayload",
}) as any as S.Schema<Erc20ApprovalPayload>;
...
export const SpendPermissionPayload = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    payloadId: S.String,
    type: SpendPermissionPayloadType,
    data: EIP712Message,
  ...
  identifier: "SpendPermissionPayload",
}) as any as S.Schema<SpendPermissionPayload>;

/** A single onchain payload the payer must process to complete an onchain payment option. Inspect `type` to determine how to handle the `data` field: - `eip3009` — pass `data` to `eth_signTypedData_v4`, return the signature. - `permit2` — pass `data` to `eth_signTypedData_v4`, return the signature. - `erc20_approval` — send `data` via `eth_sendTransaction`, return the transaction hash. - `spend_permission` — pass `data` to `eth_signTypedData_v4`, return the signature. */
...
export type WalletAuthorizationOptionPayloadsList =
  Array<OnchainSignaturePayload>;
export const WalletAuthorizationOptionPayloadsList = /*@__PURE__*/ S.Array(
  OnchainSignaturePayload,
) as any as S.Schema<WalletAuthorizationOptionPayloadsList>;
...
export interface WalletAuthorizationOption {
  ...
  network: PaymentSourceNetwork;
  /** The payloads the payer must sign or submit to authorize the payment via this option. */
  payloads: WalletAuthorizationOptionPayloadsList;
}
export const WalletAuthorizationOption = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    optionId: S.String,
    source: PaymentSourceWallet,
    amount: S.String,
  ...
  identifier: "WalletAuthorizationOption",
}) as any as S.Schema<WalletAuthorizationOption>;

/** The available wallet authorization options. */
export type WalletAuthorizationOptionsResponseOptionsList =
  Array<WalletAuthorizationOption>;
export const WalletAuthorizationOptionsResponseOptionsList =
  /*@__PURE__*/ S.Array(
    WalletAuthorizationOption,
  ) as any as S.Schema<WalletAuthorizationOptionsResponseOptionsList>;
...
export const WalletAuthorizationFundsRequirement = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    asset: S.String,
    network: PaymentSourceNetwork,
    currentBalance: S.String,
  ...
  identifier: "WalletAuthorizationFundsRequirement",
}) as any as S.Schema<WalletAuthorizationFundsRequirement>;
...
export type IneligibleWalletAuthorizationAddressFundsRequiredList =
  Array<WalletAuthorizationFundsRequirement>;
export const IneligibleWalletAuthorizationAddressFundsRequiredList =
  /*@__PURE__*/ S.Array(
    WalletAuthorizationFundsRequirement,
  ) as any as S.Schema<IneligibleWalletAuthorizationAddressFundsRequiredList>;
...
export interface IneligibleWalletAuthorizationAddress {
  ...
  message: string;
  /** The funding options for this address, one entry per (network, asset) combination the payer could fund to become eligible. Only present when `code` is `insufficient_funds`, and honors the request's `network` and `asset` filters. May be an empty array. */
  fundsRequired?: IneligibleWalletAuthorizationAddressFundsRequiredList;
}
export const IneligibleWalletAuthorizationAddress = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      address: S.String,
      code: IneligibleWalletAuthorizationAddressCode,
      message: S.String,
      fundsRequired: S.optional(
        IneligibleWalletAuthorizationAddressFundsRequiredList,
      ),
    }),
).annotate({
  identifier: "IneligibleWalletAuthorizationAddress",
}) as any as S.Schema<IneligibleWalletAuthorizationAddress>;
...
export type WalletAuthorizationOptionsResponseIneligibleAddressesList =
  Array<IneligibleWalletAuthorizationAddress>;
export const WalletAuthorizationOptionsResponseIneligibleAddressesList =
  /*@__PURE__*/ S.Array(
    IneligibleWalletAuthorizationAddress,
  ) as any as S.Schema<WalletAuthorizationOptionsResponseIneligibleAddressesList>;
...
export interface WalletAuthorizationOptionsResponse {
  /** The available wallet authorization options. */
  options: WalletAuthorizationOptionsResponseOptionsList;
  /** Requested payer addresses that have no eligible authorization option, each with a `code` explaining why. Empty when every requested address can authorize the payment. */
  ineligibleAddresses: WalletAuthorizationOptionsResponseIneligibleAddressesList;
}
export const WalletAuthorizationOptionsResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    options: WalletAuthorizationOptionsResponseOptionsList,
    ineligibleAddresses:
      WalletAuthorizationOptionsResponseIneligibleAddressesList,
  }),
).annotate({
  identifier: "WalletAuthorizationOptionsResponse",
}) as any as S.Schema<WalletAuthorizationOptionsResponse>;
...
export interface GetX402BundleRequest {
  /** The unique, URL-safe slug identifying the bundle (as returned by `GET /v2/x402/discovery/bundles`). */
  bundleSlug: string;
}
export const GetX402BundleRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    bundleSlug: S.String.pipe(T.Label()),
  }).pipe(
    T.Http({
      method: "GET",
      uri: "/v2/x402/discovery/bundles/{bundleSlug}",
      code: 200,
    }),
  ),
).annotate({
  identifier: "GetX402BundleRequest",
}) as any as S.Schema<GetX402BundleRequest>;
...
export type X402DiscoveryResourceBundleSlugsList = Array<string>;
export const X402DiscoveryResourceBundleSlugsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<X402DiscoveryResourceBundleSlugsList>;
...
export interface X402DiscoveryResource {
  ...
  /** Slugs of the curated x402 bundles this resource belongs to. A bundle is an ordered, named grouping of curated resources covering a common agent workflow. Present only for Coinbase-curated resources (`curated: true`); omitted when the resource is not curated or is not a member of any bundle. */
  bundleSlugs?: X402DiscoveryResourceBundleSlugsList;
...
export const X402DiscoveryResource = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    bundleSlugs: S.optional(X402DiscoveryResourceBundleSlugsList),
    iconUrl: S.optional(S.String),
    curated: S.optional(S.Boolean),
    skillUrl: S.optional(S.String),
  }),
).annotate({
...
export type GetX402BundleResponseResourcesList = Array<X402DiscoveryResource>;
export const GetX402BundleResponseResourcesList = /*@__PURE__*/ S.Array(
  X402DiscoveryResource,
) as any as S.Schema<GetX402BundleResponseResourcesList>;

export interface GetX402BundleResponse {
  ...
  description?: string;
  /** The bundle's member resources in bundle-defined order. Each entry is the full discovery metadata for a curated endpoint belonging to this bundle. Bundle membership is capped at 50 resources. */
  resources: GetX402BundleResponseResourcesList;
}
export const GetX402BundleResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    slug: S.String,
    name: S.String,
    description: S.optional(S.String),
  ...
  identifier: "GetX402BundleResponse",
}) as any as S.Schema<GetX402BundleResponse>;
...
export interface ListCoinbaseAccountBalancesRequest {}
export const ListCoinbaseAccountBalancesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}).pipe(
    T.Http({ method: "GET", uri: "/v2/coinbase-accounts/balances", code: 200 }),
  ),
).annotate({
  identifier: "ListCoinbaseAccountBalancesRequest",
}) as any as S.Schema<ListCoinbaseAccountBalancesRequest>;

/** The list of balances. */
export type BalancesBalancesList = Array<Balance>;
export const BalancesBalancesList = /*@__PURE__*/ S.Array(
  Balance,
) as any as S.Schema<BalancesBalancesList>;

/** A list of balances for an account. */
export interface Balances {
  /** The list of balances. */
  balances: BalancesBalancesList;
}
export const Balances = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    balances: BalancesBalancesList,
  }),
).annotate({ identifier: "Balances" }) as any as S.Schema<Balances>;
...
export const ListCustomersRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    pageSize: S.optional(S.Number.pipe(T.Query())),
    pageToken: S.optional(S.String.pipe(T.Query())),
  }).pipe(T.Http({ method: "GET", uri: "/v2/customers", code: 200 })),
).annotate({
  identifier: "ListCustomersRequest",
}) as any as S.Schema<ListCustomersRequest>;

/** The list of customers. */
export type ListCustomersResponseCustomersList = Array<Customer>;
export const ListCustomersResponseCustomersList = /*@__PURE__*/ S.Array(
  Customer,
) as any as S.Schema<ListCustomersResponseCustomersList>;

export interface ListCustomersResponse {
  /** The list of customers. */
  customers: ListCustomersResponseCustomersList;
  /** The token for the next page of items, if any. */
  nextPageToken?: string;
}
...
export interface ListDisbursementsRequest {
  /** The number of resources to return per page. */
  pageSize?: number;
  /** The token for the next page of resources, if any. */
  pageToken?: string;
  /** Filter disbursements by status. */
  status?: PaymentActionStatus | (string & {});
  /** Filter disbursements by the source CDP account ID. */
  sourceAccountId?: string;
  /** Filter disbursements by the client-supplied external reference ID. */
  externalReferenceId?: string;
}
export const ListDisbursementsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    pageSize: S.optional(S.Number.pipe(T.Query())),
    pageToken: S.optional(S.String.pipe(T.Query())),
    status: S.optional(PaymentActionStatus.pipe(T.Query())),
    sourceAccountId: S.optional(S.String.pipe(T.Query())),
    externalReferenceId: S.optional(S.String.pipe(T.Query())),
  }).pipe(T.Http({ method: "GET", uri: "/v2/disbursements", code: 200 })),
).annotate({
  identifier: "ListDisbursementsRequest",
}) as any as S.Schema<ListDisbursementsRequest>;

/** The list of disbursements. */
export type ListDisbursementsResponseDisbursementsList = Array<Disbursement>;
export const ListDisbursementsResponseDisbursementsList = /*@__PURE__*/ S.Array(
  Disbursement,
) as any as S.Schema<ListDisbursementsResponseDisbursementsList>;

export interface ListDisbursementsResponse {
  /** The list of disbursements. */
  disbursements: ListDisbursementsResponseDisbursementsList;
  /** The token for the next page of items, if any. */
  nextPageToken?: string;
}
export const ListDisbursementsResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    disbursements: ListDisbursementsResponseDisbursementsList,
    nextPageToken: S.optional(S.String),
  }),
).annotate({
  identifier: "ListDisbursementsResponse",
...
export type ListFoundationAccountsRequestOwnerList = Array<string>;
export const ListFoundationAccountsRequestOwnerList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<ListFoundationAccountsRequestOwnerList>;
...
export interface ListFoundationAccountsRequest {
  ...
  owner?: ListFoundationAccountsRequestOwnerList;
...
export const ListFoundationAccountsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    pageSize: S.optional(S.Number.pipe(T.Query())),
    pageToken: S.optional(S.String.pipe(T.Query())),
    owner: S.optional(ListFoundationAccountsRequestOwnerList.pipe(T.Query())),
...
export interface ListPaymentSessionAuthorizationsRequest {
  /** The unique identifier of the payment session. */
  paymentSessionId: string;
  /** The number of resources to return per page. */
  pageSize?: number;
...
export const ListPaymentSessionAuthorizationsRequest = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      paymentSessionId: S.String.pipe(T.Label()),
      pageSize: S.optional(S.Number.pipe(T.Query())),
      ...
      T.Http({
        method: "GET",
        uri: "/v2/payment-sessions/{paymentSessionId}/authorizations",
        code: 200,
      }),
    ),
).annotate({
  identifier: "ListPaymentSessionAuthorizationsRequest",
}) as any as S.Schema<ListPaymentSessionAuthorizationsRequest>;

/** The list of authorizations. */
export type ListPaymentSessionAuthorizationsResponseAuthorizationsList =
  Array<Authorization>;
export const ListPaymentSessionAuthorizationsResponseAuthorizationsList =
  /*@__PURE__*/ S.Array(
    Authorization,
  ) as any as S.Schema<ListPaymentSessionAuthorizationsResponseAuthorizationsList>;

export interface ListPaymentSessionAuthorizationsResponse {
  /** The list of authorizations. */
  authorizations: ListPaymentSessionAuthorizationsResponseAuthorizationsList;
  /** The token for the next page of items, if any. */
  nextPageToken?: string;
}
export const ListPaymentSessionAuthorizationsResponse = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      authorizations:
        ListPaymentSessionAuthorizationsResponseAuthorizationsList,
      nextPageToken: S.optional(S.String),
    }),
).annotate({
  identifier: "ListPaymentSessionAuthorizationsResponse",
}) as any as S.Schema<ListPaymentSessionAuthorizationsResponse>;

export interface ListPaymentSessionCapturesRequest {
  /** The unique identifier of the payment session. */
  paymentSessionId: string;
  /** The number of resources to return per page. */
  pageSize?: number;
...
export const ListPaymentSessionCapturesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    paymentSessionId: S.String.pipe(T.Label()),
    pageSize: S.optional(S.Number.pipe(T.Query())),
    pageToken: S.optional(S.String.pipe(T.Query())),
  ...
  identifier: "ListPaymentSessionCapturesRequest",
}) as any as S.Schema<ListPaymentSessionCapturesRequest>;

/** The list of captures. */
export type ListPaymentSessionCapturesResponseCapturesList = Array<Capture>;
export const ListPaymentSessionCapturesResponseCapturesList =
  /*@__PURE__*/ S.Array(
    Capture,
  ) as any as S.Schema<ListPaymentSessionCapturesResponseCapturesList>;

export interface ListPaymentSessionCapturesResponse {
  /** The list of captures. */
  captures: ListPaymentSessionCapturesResponseCapturesList;
  /** The token for the next page of items, if any. */
  nextPageToken?: string;
}
export const ListPaymentSessionCapturesResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    captures: ListPaymentSessionCapturesResponseCapturesList,
    nextPageToken: S.optional(S.String),
  }),
).annotate({
  identifier: "ListPaymentSessionCapturesResponse",
}) as any as S.Schema<ListPaymentSessionCapturesResponse>;

export interface ListPaymentSessionRefundsRequest {
  /** The unique identifier of the payment session. */
  paymentSessionId: string;
  /** The number of resources to return per page. */
  pageSize?: number;
...
export const ListPaymentSessionRefundsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    paymentSessionId: S.String.pipe(T.Label()),
    pageSize: S.optional(S.Number.pipe(T.Query())),
    pageToken: S.optional(S.String.pipe(T.Query())),
    ...
    T.Http({
      method: "GET",
      uri: "/v2/payment-sessions/{paymentSessionId}/refunds",
      code: 200,
    }),
  ),
).annotate({
  identifier: "ListPaymentSessionRefundsRequest",
}) as any as S.Schema<ListPaymentSessionRefundsRequest>;

/** The list of refunds. */
export type ListPaymentSessionRefundsResponseRefundsList = Array<Refund>;
export const ListPaymentSessionRefundsResponseRefundsList =
  /*@__PURE__*/ S.Array(
    Refund,
  ) as any as S.Schema<ListPaymentSessionRefundsResponseRefundsList>;

export interface ListPaymentSessionRefundsResponse {
  /** The list of refunds. */
  refunds: ListPaymentSessionRefundsResponseRefundsList;
  /** The token for the next page of items, if any. */
  nextPageToken?: string;
}
export const ListPaymentSessionRefundsResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    refunds: ListPaymentSessionRefundsResponseRefundsList,
    nextPageToken: S.optional(S.String),
  }),
).annotate({
  identifier: "ListPaymentSessionRefundsResponse",
}) as any as S.Schema<ListPaymentSessionRefundsResponse>;
...
export const ListPaymentSessionsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    pageSize: S.optional(S.Number.pipe(T.Query())),
    pageToken: S.optional(S.String.pipe(T.Query())),
  }).pipe(T.Http({ method: "GET", uri: "/v2/payment-sessions", code: 200 })),
).annotate({
  identifier: "ListPaymentSessionsRequest",
}) as any as S.Schema<ListPaymentSessionsRequest>;

/** The list of payment sessions. */
export type ListPaymentSessionsResponsePaymentSessionsList =
  Array<PaymentSession>;
export const ListPaymentSessionsResponsePaymentSessionsList =
  /*@__PURE__*/ S.Array(
    PaymentSession,
  ) as any as S.Schema<ListPaymentSessionsResponsePaymentSessionsList>;

export interface ListPaymentSessionsResponse {
  /** The list of payment sessions. */
  paymentSessions: ListPaymentSessionsResponsePaymentSessionsList;
  /** The token for the next page of items, if any. */
  nextPageToken?: string;
}
...
export interface ListPaymentSessionVoidsRequest {
  /** The unique identifier of the payment session. */
  paymentSessionId: string;
  /** The number of resources to return per page. */
  pageSize?: number;
...
export const ListPaymentSessionVoidsRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    paymentSessionId: S.String.pipe(T.Label()),
    pageSize: S.optional(S.Number.pipe(T.Query())),
    pageToken: S.optional(S.String.pipe(T.Query())),
    ...
    T.Http({
      method: "GET",
      uri: "/v2/payment-sessions/{paymentSessionId}/voids",
      code: 200,
    }),
  ),
).annotate({
  identifier: "ListPaymentSessionVoidsRequest",
}) as any as S.Schema<ListPaymentSessionVoidsRequest>;

/** The list of voids. */
export type ListPaymentSessionVoidsResponseVoidsList = Array<Void>;
export const ListPaymentSessionVoidsResponseVoidsList = /*@__PURE__*/ S.Array(
  Void,
) as any as S.Schema<ListPaymentSessionVoidsResponseVoidsList>;

export interface ListPaymentSessionVoidsResponse {
  /** The list of voids. */
  voids: ListPaymentSessionVoidsResponseVoidsList;
  /** The token for the next page of items, if any. */
  nextPageToken?: string;
}
export const ListPaymentSessionVoidsResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    voids: ListPaymentSessionVoidsResponseVoidsList,
    nextPageToken: S.optional(S.String),
  }),
).annotate({
  identifier: "ListPaymentSessionVoidsResponse",
...
export interface ListX402BundlesRequest {}
export const ListX402BundlesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({}).pipe(
    T.Http({ method: "GET", uri: "/v2/x402/discovery/bundles", code: 200 }),
  ),
).annotate({
  identifier: "ListX402BundlesRequest",
}) as any as S.Schema<ListX402BundlesRequest>;
...
export const X402Bundle = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    slug: S.String,
    name: S.String,
    description: S.optional(S.String),
  }),
).annotate({ identifier: "X402Bundle" }) as any as S.Schema<X402Bundle>;

/** The list of available curated bundles. This list is empty when no bundles are defined. */
export type X402BundlesResponseBundlesList = Array<X402Bundle>;
export const X402BundlesResponseBundlesList = /*@__PURE__*/ S.Array(
  X402Bundle,
) as any as S.Schema<X402BundlesResponseBundlesList>;
...
export interface X402BundlesResponse {
  /** The list of available curated bundles. This list is empty when no bundles are defined. */
  bundles: X402BundlesResponseBundlesList;
}
export const X402BundlesResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    bundles: X402BundlesResponseBundlesList,
  }),
).annotate({
  identifier: "X402BundlesResponse",
}) as any as S.Schema<X402BundlesResponse>;
...
export const RefundPaymentSessionRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    paymentSessionId: S.String.pipe(T.Label()),
    source: RefundSource,
    amount: S.optional(S.String),
  ...
  identifier: "RefundPaymentSessionRequest",
}) as any as S.Schema<RefundPaymentSessionRequest>;
...
export interface RequestLimitsUpgradeRequest {
  ...
  interactionMode?: OnrampLimitUpgradeInteractionMode | (string & {});
...
export const RequestLimitsUpgradeRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    userId: S.String,
    userIdType: OnrampUserIdType,
    interactionMode: S.optional(OnrampLimitUpgradeInteractionMode),
...
export const OnrampLimitUpgradeEmbeddedResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    upgradeUrl: S.String,
    expiresAt: S.String,
  }),
).annotate({
  identifier: "OnrampLimitUpgradeEmbeddedResponse",
}) as any as S.Schema<OnrampLimitUpgradeEmbeddedResponse>;
...
export type SearchX402ResourcesRequestTagsList = Array<string>;
export const SearchX402ResourcesRequestTagsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<SearchX402ResourcesRequestTagsList>;

export type SearchX402ResourcesRequestBundleSlugsList = Array<string>;
export const SearchX402ResourcesRequestBundleSlugsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<SearchX402ResourcesRequestBundleSlugsList>;
...
export interface SearchX402ResourcesRequest {
  ...
  tags?: SearchX402ResourcesRequestTagsList;
  ...
  bundleSlugs?: SearchX402ResourcesRequestBundleSlugsList;
...
export const SearchX402ResourcesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    tags: S.optional(SearchX402ResourcesRequestTagsList.pipe(T.Query())),
    bundleSlugs: S.optional(
      SearchX402ResourcesRequestBundleSlugsList.pipe(T.Query()),
    ),
    curatedOnly: S.optional(S.Boolean.pipe(T.Query())),
    limit: S.optional(S.Number.pipe(T.Query())),
  }).pipe(
...
export type X402PaymentRequiredAcceptsList = Array<X402PaymentRequirements>;
export const X402PaymentRequiredAcceptsList = /*@__PURE__*/ S.Array(
  X402PaymentRequirements,
) as any as S.Schema<X402PaymentRequiredAcceptsList>;

/** Optional protocol extensions. Unknown keys are forwarded as-is into the signed payment payload. */
export type X402PaymentRequiredExtensionsMap = {
  [key: string]: unknown | undefined;
};
export const X402PaymentRequiredExtensionsMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
) as any as S.Schema<X402PaymentRequiredExtensionsMap>;
...
export interface X402PaymentRequired {
  ...
  x402Version: X402Version | (number & {});
  /** The list of payment options the resource server accepts. At least one option must be present. */
  accepts: X402PaymentRequiredAcceptsList;
  ...
  error?: string;
  /** Optional protocol extensions. Unknown keys are forwarded as-is into the signed payment payload. */
  extensions?: X402PaymentRequiredExtensionsMap;
}
export const X402PaymentRequired = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    x402Version: X402Version,
    accepts: X402PaymentRequiredAcceptsList,
    resource: S.optional(X402ResourceInfo),
    error: S.optional(S.String),
    extensions: S.optional(X402PaymentRequiredExtensionsMap),
  }),
).annotate({
  identifier: "X402PaymentRequired",
}) as any as S.Schema<X402PaymentRequired>;

export interface SignSolanaX402PaymentWithEndUserAccountRequest {
  /** The ID of the end user. */
  userId: string;
  /** The ID of the CDP Project. Required for end users authenticated using custom auth (i.e. a non-CDP JWT provider). */
  projectID?: string;
...
export const SignSolanaX402PaymentWithEndUserAccountRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      userId: S.String.pipe(T.Label()),
      projectID: S.optional(S.String.pipe(T.Query())),
      paymentRequired: X402PaymentRequired,
      acceptsIndex: S.Number,
      address: S.String,
      walletSecretId: S.optional(S.String),
    }).pipe(
      T.Http({
        method: "POST",
        uri: "/v2/embedded-wallet-api/end-users/{userId}/solana/sign/x402-payment",
        code: 200,
      }),
    ),
  ).annotate({
    identifier: "SignSolanaX402PaymentWithEndUserAccountRequest",
  }) as any as S.Schema<SignSolanaX402PaymentWithEndUserAccountRequest>;

export interface SignSolanaX402PaymentWithEndUserAccountResponse {
  /** The signed x402 payment payload. Base64-encode this and send it in the PAYMENT-SIGNATURE header of the resource request. */
  paymentPayload: X402PaymentPayload;
}
export const SignSolanaX402PaymentWithEndUserAccountResponse =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      paymentPayload: X402PaymentPayload,
    }),
  ).annotate({
    identifier: "SignSolanaX402PaymentWithEndUserAccountResponse",
  }) as any as S.Schema<SignSolanaX402PaymentWithEndUserAccountResponse>;
...
/** The project IDs that this customer is associated with. */
export type UpdateCustomerByIdRequestProjectIdsList = Array<string>;
export const UpdateCustomerByIdRequestProjectIdsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<UpdateCustomerByIdRequestProjectIdsList>;

/** Terms of Service acceptances to record on the customer. Submit one entry per required version surfaced inline on `requirements.tos.tosVersions[]` (returned by `Get Customer`, `Create Customer`, and `Update Customer` whenever a `tos` requirement is unsatisfied). The server rejects each acceptance whose `language` is not listed under `languages` on the matching required version with `errorType: "unsupported_tos_language"`. When new required Terms of Service versions are published, only the new `versionId`s appear in `requirements.tos.tosVersions[]`; submit acceptances for only those new version(s). Omit `tosAcceptances` on a partial update to leave previously recorded acceptances unchanged. Sending `tosAcceptances: []` is invalid (`errorType: "invalid_request"`) because it would clear all acceptances without replacing them; omit the field entirely when you are not updating Terms of Service acceptances. */
export type UpdateCustomerByIdRequestTosAcceptancesList = Array<TosAcceptance>;
export const UpdateCustomerByIdRequestTosAcceptancesList =
  /*@__PURE__*/ S.Array(
    TosAcceptance,
  ) as any as S.Schema<UpdateCustomerByIdRequestTosAcceptancesList>;

/** Tax attestations to record on the customer. Submit one entry per required form surfaced inline on `requirements.taxAttestation.taxForms[]` (returned by `Get Customer`, `Create Customer`, and `Update Customer` whenever a `taxAttestation` requirement is unsatisfied). The required fields per entry depend on `form`; see `TaxAttestation`. This field is ingestion-only and is never returned on read. Omit `taxAttestations` on a partial update to leave previously recorded attestations unchanged. Sending `taxAttestations: []` is invalid (`errorType: "invalid_request"`) because it would clear all attestations without replacing them; omit the field entirely when you are not updating tax attestations. */
export type UpdateCustomerByIdRequestTaxAttestationsList =
  Array<UsW9Attestation>;
export const UpdateCustomerByIdRequestTaxAttestationsList =
  /*@__PURE__*/ S.Array(
    UsW9Attestation,
  ) as any as S.Schema<UpdateCustomerByIdRequestTaxAttestationsList>;
...
export interface UpdateCustomerByIdRequest {
  ...
  individual?: IndividualInput;
  /** The project IDs that this customer is associated with. */
  projectIds?: UpdateCustomerByIdRequestProjectIdsList;
  /** Terms of Service acceptances to record on the customer. Submit one entry per required version surfaced inline on `requirements.tos.tosVersions[]` (returned by `Get Customer`, `Create Customer`, and `Update Customer` whenever a `tos` requirement is unsatisfied). The server rejects each acceptance whose `language` is not listed under `languages` on the matching required version with `errorType: "unsupported_tos_language"`. When new required Terms of Service versions are published, only the new `versionId`s appear in `requirements.tos.tosVersions[]`; submit acceptances for only those new version(s). Omit `tosAcceptances` on a partial update to leave previously recorded acceptances unchanged. Sending `tosAcceptances: []` is invalid (`errorType: "invalid_request"`) because it would clear all acceptances without replacing them; omit the field entirely when you are not updating Terms of Service acceptances. */
  tosAcceptances?: UpdateCustomerByIdRequestTosAcceptancesList;
  /** Tax attestations to record on the customer. Submit one entry per required form surfaced inline on `requirements.taxAttestation.taxForms[]` (returned by `Get Customer`, `Create Customer`, and `Update Customer` whenever a `taxAttestation` requirement is unsatisfied). The required fields per entry depend on `form`; see `TaxAttestation`. This field is ingestion-only and is never returned on read. Omit `taxAttestations` on a partial update to leave previously recorded attestations unchanged. Sending `taxAttestations: []` is invalid (`errorType: "invalid_request"`) because it would clear all attestations without replacing them; omit the field entirely when you are not updating tax attestations. */
  taxAttestations?: UpdateCustomerByIdRequestTaxAttestationsList;
  compliance?: Compliance;
}
export const UpdateCustomerByIdRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    customerId: S.String.pipe(T.Label()),
    type: S.optional(CustomerType),
    capabilities: S.optional(CapabilitiesMapInput),
    individual: S.optional(IndividualInput),
    projectIds: S.optional(UpdateCustomerByIdRequestProjectIdsList),
    tosAcceptances: S.optional(UpdateCustomerByIdRequestTosAcceptancesList),
    taxAttestations: S.optional(UpdateCustomerByIdRequestTaxAttestationsList),
    compliance: S.optional(Compliance),
  }).pipe(
    T.Http({ method: "PUT", uri: "/v2/customers/{customerId}", code: 200 }),
  ),
).annotate({
  identifier: "UpdateCustomerByIdRequest",
}) as any as S.Schema<UpdateCustomerByIdRequest>;
...
export interface VoidPaymentSessionRequest {
  /** The unique identifier of the payment session. */
  paymentSessionId: string;
  metadata?: Metadata;
...
export const VoidPaymentSessionRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    paymentSessionId: S.String.pipe(T.Label()),
    metadata: S.optional(Metadata),
    externalReferenceId: S.optional(S.String),
  ...
  identifier: "VoidPaymentSessionRequest",
}) as any as S.Schema<VoidPaymentSessionRequest>;
...
export const authorizeCoinbasePaymentSession: API.OperationMethod<
  ...
  Authorization,
  AuthorizeCoinbasePaymentSessionError,
  CoinbaseOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: AuthorizeCoinbasePaymentSessionRequest,
...
export const authorizeWalletPaymentSession: API.OperationMethod<
  ...
  Authorization,
  AuthorizeWalletPaymentSessionError,
  CoinbaseOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: AuthorizeWalletPaymentSessionRequest,
  output: Authorization,
  errors: [UnknownCoinbaseError],
  protocol: CoinbaseProtocol,
  retry: Retry.Retry,
...
export const authorizeX402PaymentSession: API.OperationMethod<
  ...
  Authorization,
  AuthorizeX402PaymentSessionError,
  CoinbaseOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: AuthorizeX402PaymentSessionRequest,
  output: Authorization,
  errors: [UnknownCoinbaseError],
  protocol: CoinbaseProtocol,
  retry: Retry.Retry,
...
export type GetDisbursementError = CoinbaseOpError;
/** Get a disbursement Retrieves a single disbursement by its ID, including source, target, status, amount, associated onchain transactions, error details (if failed), and timestamps. Only returns the disbursement if the API key has permission to access it. */
export const getDisbursement: API.OperationMethod<
  GetDisbursementRequest,
  Disbursement,
  GetDisbursementError,
  CoinbaseOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetDisbursementRequest,
  output: Disbursement,
  errors: [UnknownCoinbaseError],
  protocol: CoinbaseProtocol,
  retry: Retry.Retry,
...
export type GetPaymentSessionError = CoinbaseOpError;
/** Get a payment session Retrieves a single payment session by its ID, including its current status, balances, and associated metadata. The API key must have permission to access the requested session. */
...
export type GetPaymentSessionAuthorizationError = CoinbaseOpError;
/** Get a payment session authorization Retrieves a single authorization by its ID, including its current status, amount, and any associated onchain transactions. */
export const getPaymentSessionAuthorization: API.OperationMethod<
  GetPaymentSessionAuthorizationRequest,
  Authorization,
  GetPaymentSessionAuthorizationError,
  CoinbaseOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetPaymentSessionAuthorizationRequest,
  output: Authorization,
  errors: [UnknownCoinbaseError],
  protocol: CoinbaseProtocol,
  retry: Retry.Retry,
...
export type GetPaymentSessionCaptureError = CoinbaseOpError;
/** Get a payment session capture Retrieves a single capture by its ID, including status, captured amount, associated onchain transactions, and timestamps. Only returns the capture if the API key has permission to access it. */
export const getPaymentSessionCapture: API.OperationMethod<
  GetPaymentSessionCaptureRequest,
  Capture,
  GetPaymentSessionCaptureError,
  CoinbaseOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetPaymentSessionCaptureRequest,
  output: Capture,
  errors: [UnknownCoinbaseError],
  protocol: CoinbaseProtocol,
  retry: Retry.Retry,
...
export type GetPaymentSessionRefundError = CoinbaseOpError;
/** Get a payment session refund Retrieves a single refund by its ID, including status, refunded amount, reason, associated onchain transactions, and timestamps. Only returns the refund if the API key has permission to access it. */
export const getPaymentSessionRefund: API.OperationMethod<
  GetPaymentSessionRefundRequest,
  Refund,
  GetPaymentSessionRefundError,
  CoinbaseOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetPaymentSessionRefundRequest,
  output: Refund,
  errors: [UnknownCoinbaseError],
  protocol: CoinbaseProtocol,
  retry: Retry.Retry,
...
export type GetPaymentSessionVoidError = CoinbaseOpError;
/** Get a payment session void Retrieves a single void by its ID, including status, voided amount, associated onchain transactions, and timestamps. Only returns the void if the API key has permission to access it. */
export const getPaymentSessionVoid: API.OperationMethod<
  GetPaymentSessionVoidRequest,
  Void,
  GetPaymentSessionVoidError,
  CoinbaseOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetPaymentSessionVoidRequest,
  output: Void,
  errors: [UnknownCoinbaseError],
  protocol: CoinbaseProtocol,
  retry: Retry.Retry,
...
export type GetX402BundleError = CoinbaseOpError;
/** Get an x402 bundle Gets a single curated x402 workflow bundle by its bundle slug, including the bundle metadata and its ordered member resources joined to their full discovery metadata. */
export const getX402Bundle: API.OperationMethod<
  GetX402BundleRequest,
  GetX402BundleResponse,
  GetX402BundleError,
  CoinbaseOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetX402BundleRequest,
  output: GetX402BundleResponse,
  errors: [UnknownCoinbaseError],
  protocol: CoinbaseProtocol,
  retry: Retry.Retry,
}));
...
export type ListCustomersError = CoinbaseOpError;
/** List customers List all customers. The API will return all customers that the API Key has permissions to access. Results are not returned in any guaranteed order. */
...
export type ListDisbursementsError = CoinbaseOpError;
/** List disbursements Returns a paginated list of disbursements created by the merchant. Each disbursement includes its source, target, status, amount, and timestamps. Only disbursements accessible by the current API key are returned. */
export const listDisbursements: API.OperationMethod<
  ListDisbursementsRequest,
  ListDisbursementsResponse,
  ListDisbursementsError,
  CoinbaseOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: ListDisbursementsRequest,
  output: ListDisbursementsResponse,
  errors: [UnknownCoinbaseError],
  protocol: CoinbaseProtocol,
  retry: Retry.Retry,
}));
...
export type ListPaymentSessionAuthorizationsError = CoinbaseOpError;
/** List payment session authorizations Returns a paginated list of authorizations for a payment session. Each authorization represents a hold on funds and includes its current status and amount. */
export const listPaymentSessionAuthorizations: API.OperationMethod<
  ListPaymentSessionAuthorizationsRequest,
  ListPaymentSessionAuthorizationsResponse,
  ListPaymentSessionAuthorizationsError,
  CoinbaseOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: ListPaymentSessionAuthorizationsRequest,
  output: ListPaymentSessionAuthorizationsResponse,
  errors: [UnknownCoinbaseError],
  protocol: CoinbaseProtocol,
  retry: Retry.Retry,
}));

export type ListPaymentSessionCapturesError = CoinbaseOpError;
/** List payment session captures Returns a paginated list of captures for a payment session. Each capture includes its status, amount, associated onchain transactions, and timestamps. Only captures accessible by the current API key are returned. */
export const listPaymentSessionCaptures: API.OperationMethod<
  ListPaymentSessionCapturesRequest,
  ListPaymentSessionCapturesResponse,
  ListPaymentSessionCapturesError,
  CoinbaseOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: ListPaymentSessionCapturesRequest,
  output: ListPaymentSessionCapturesResponse,
  errors: [UnknownCoinbaseError],
  protocol: CoinbaseProtocol,
  retry: Retry.Retry,
}));

export type ListPaymentSessionRefundsError = CoinbaseOpError;
/** List payment session refunds Returns a paginated list of refunds for a payment session. Each refund includes its status, amount, reason, associated onchain transactions, and timestamps. Only refunds accessible by the current API key are returned. */
export const listPaymentSessionRefunds: API.OperationMethod<
  ListPaymentSessionRefundsRequest,
  ListPaymentSessionRefundsResponse,
  ListPaymentSessionRefundsError,
  CoinbaseOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: ListPaymentSessionRefundsRequest,
  output: ListPaymentSessionRefundsResponse,
  errors: [UnknownCoinbaseError],
  protocol: CoinbaseProtocol,
  retry: Retry.Retry,
}));

export type ListPaymentSessionsError = CoinbaseOpError;
/** List payment sessions Returns a paginated list of payment sessions that the API key has permission to access. */
...
export type ListPaymentSessionVoidsError = CoinbaseOpError;
/** List payment session voids Returns a paginated list of voids for a payment session. Each void includes its status, amount, associated onchain transactions, and timestamps. Only voids accessible by the current API key are returned. */
export const listPaymentSessionVoids: API.OperationMethod<
  ListPaymentSessionVoidsRequest,
  ListPaymentSessionVoidsResponse,
  ListPaymentSessionVoidsError,
  CoinbaseOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: ListPaymentSessionVoidsRequest,
  output: ListPaymentSessionVoidsResponse,
  errors: [UnknownCoinbaseError],
  protocol: CoinbaseProtocol,
  retry: Retry.Retry,
}));
...
export type ListX402BundlesError = CoinbaseOpError;
/** List x402 bundles Lists the available curated x402 workflow bundles. A bundle is an ordered, named grouping of curated x402 resources that together cover a common agent workflow. The result set is small and server-controlled, so this endpoint is not paginated. */
export const listX402Bundles: API.OperationMethod<
  ListX402BundlesRequest,
  X402BundlesResponse,
  ListX402BundlesError,
  CoinbaseOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: ListX402BundlesRequest,
  output: X402BundlesResponse,
  errors: [UnknownCoinbaseError],
  protocol: CoinbaseProtocol,
  retry: Retry.Retry,
}));
...
> = /*@__PURE__*/ API.make(() => ({
  ...
  output: OnrampLimitUpgradeEmbeddedResponse,
  errors: [UnknownCoinbaseError],
  protocol: CoinbaseProtocol,
  retry: Retry.Retry,
}));
...
export type UpdateCustomerByIdError = CoinbaseOpError;
/** Update a customer Update customer information and/or request capability changes. This endpoint supports partial updates. Provide only the fields you wish to change. */
export const updateCustomerById: API.OperationMethod<
  UpdateCustomerByIdRequest,
  Customer,
  UpdateCustomerByIdError,
  CoinbaseOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: UpdateCustomerByIdRequest,
  output: Customer,
  errors: [UnknownCoinbaseError],
  protocol: CoinbaseProtocol,
  retry: Retry.Retry,
