...
export interface ChatUnfurlRequest {
  ...
  unfurl_id?: string;
  /** The source of the link to unfurl. The source may either be `composer`, when the link is inside the message composer, or `conversations_history`, when the link has been posted to a conversation. */
  source?: ChatUnfurlRequestSource | (string & {});
}
export const ChatUnfurlRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
...
export const ChatUnfurlResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ok: S.Boolean,
  }),
).annotate({
...
export interface ListScheduledMessagesResponseScheduledMessagesItem {
  id: string;
  channel_id: string;
  post_at: number;
  date_created: number;
...
export const ListScheduledMessagesResponseScheduledMessagesItem =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      id: S.String,
      channel_id: S.String,
    ...
    identifier: "ListScheduledMessagesResponseScheduledMessagesItem",
  }) as any as S.Schema<ListScheduledMessagesResponseScheduledMessagesItem>;

export type ListScheduledMessagesResponseScheduledMessagesList =
  Array<ListScheduledMessagesResponseScheduledMessagesItem>;
export const ListScheduledMessagesResponseScheduledMessagesList =
  /*@__PURE__*/ S.Array(
    ListScheduledMessagesResponseScheduledMessagesItem,
  ) as any as S.Schema<ListScheduledMessagesResponseScheduledMessagesList>;

/** Pagination metadata. An empty `next_cursor` means the last page. */
export interface ListScheduledMessagesResponseResponseMetadata {
  /** Cursor for the next page — pass as `cursor` on the next call. */
  next_cursor?: string;
}
export const ListScheduledMessagesResponseResponseMetadata =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      next_cursor: S.optional(S.String),
    }),
  ).annotate({
    identifier: "ListScheduledMessagesResponseResponseMetadata",
  }) as any as S.Schema<ListScheduledMessagesResponseResponseMetadata>;

export interface ListScheduledMessagesResponse {
  /** Always `true` (a failed call raises a typed error instead). */
  ok: boolean;
  scheduled_messages: ListScheduledMessagesResponseScheduledMessagesList;
  /** Pagination metadata. An empty `next_cursor` means the last page. */
  response_metadata?: ListScheduledMessagesResponseResponseMetadata;
}
export const ListScheduledMessagesResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    response_metadata: S.optional(
      ListScheduledMessagesResponseResponseMetadata,
    ),
  }),
).annotate({
...
export const UpdateChatRequestAsUser = /*@__PURE__*/ S.Unknown.pipe(
  T.UnionCases([[], []]),
);
...
export const UpdateChatRequestAttachmentsCase1ItemMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
) as any as S.Schema<UpdateChatRequestAttachmentsCase1ItemMap>;

export type UpdateChatRequestAttachmentsCase1List =
  Array<UpdateChatRequestAttachmentsCase1ItemMap>;
export const UpdateChatRequestAttachmentsCase1List = /*@__PURE__*/ S.Array(
  UpdateChatRequestAttachmentsCase1ItemMap,
) as any as S.Schema<UpdateChatRequestAttachmentsCase1List>;

/** A JSON-based array of structured attachments, presented as a URL-encoded string. */
export type UpdateChatRequestAttachments =
  | string
  | UpdateChatRequestAttachmentsCase1List;
export const UpdateChatRequestAttachments = /*@__PURE__*/ S.Unknown.pipe(
  T.UnionCases([[], []]),
);
...
export const UpdateChatRequestBlocksCase1ItemMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
) as any as S.Schema<UpdateChatRequestBlocksCase1ItemMap>;

export type UpdateChatRequestBlocksCase1List =
  Array<UpdateChatRequestBlocksCase1ItemMap>;
export const UpdateChatRequestBlocksCase1List = /*@__PURE__*/ S.Array(
  UpdateChatRequestBlocksCase1ItemMap,
) as any as S.Schema<UpdateChatRequestBlocksCase1List>;

/** A JSON-based array of structured blocks, presented as a URL-encoded string. */
export type UpdateChatRequestBlocks = string | UpdateChatRequestBlocksCase1List;
export const UpdateChatRequestBlocks = /*@__PURE__*/ S.Unknown.pipe(
  T.UnionCases([[], []]),
);

/** Find and link channel names and usernames. Defaults to `none`. If you do not specify a value for this field, the original value set for the message will be overwritten with the default, `none`. */
export type UpdateChatRequestLinkNames = boolean | string;
export const UpdateChatRequestLinkNames = /*@__PURE__*/ S.Unknown.pipe(
  T.UnionCases([[], []]),
);

/** Array of new file ids that will be sent with this message. */
export type UpdateChatRequestFileIdsList = Array<string>;
export const UpdateChatRequestFileIdsList = /*@__PURE__*/ S.Array(
  S.String,
) as any as S.Schema<UpdateChatRequestFileIdsList>;

export interface UpdateChatRequest {
  /** Pass true to update the message as the authed user. Bot users in this context are considered authed users. */
  as_user?: UpdateChatRequestAsUser | null;
  /** A JSON-based array of structured attachments, presented as a URL-encoded string. */
  attachments?: UpdateChatRequestAttachments;
  /** A JSON-based array of structured attachments, presented as a URL-encoded string. */
  unfurled_attachments?: string | null;
  /** A JSON-based array of structured blocks, presented as a URL-encoded string. */
  blocks?: UpdateChatRequestBlocks;
  /** Accepts message text formatted in markdown. This argument should not be used in conjunction with `blocks` or `text`. Limit this field to 12,000 characters. */
  markdown_text?: string;
  ...
  channel: string;
  /** Find and link channel names and usernames. Defaults to `none`. If you do not specify a value for this field, the original value set for the message will be overwritten with the default, `none`. */
  link_names?: UpdateChatRequestLinkNames | null;
  ...
  reply_broadcast?: boolean;
  /** Array of new file ids that will be sent with this message. */
  file_ids?: UpdateChatRequestFileIdsList;
}
export const UpdateChatRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    as_user: S.optional(S.NullOr(UpdateChatRequestAsUser)),
    attachments: S.optional(UpdateChatRequestAttachments),
    unfurled_attachments: S.optional(S.NullOr(S.String)),
    blocks: S.optional(UpdateChatRequestBlocks),
    markdown_text: S.optional(S.String),
    metadata: S.optional(S.NullOr(S.String)),
    channel: S.String,
    link_names: S.optional(S.NullOr(UpdateChatRequestLinkNames)),
    parse: S.optional(S.NullOr(S.String)),
    text: S.optional(S.NullOr(S.String)),
    ts: S.String,
    reply_broadcast: S.optional(S.Boolean),
...
export const UpdateChatResponseMessageAttachmentsItemMap =
  /*@__PURE__*/ S.Record(
    S.String,
    S.Unknown,
  ) as any as S.Schema<UpdateChatResponseMessageAttachmentsItemMap>;

export type UpdateChatResponseMessageAttachmentsList =
  Array<UpdateChatResponseMessageAttachmentsItemMap>;
export const UpdateChatResponseMessageAttachmentsList = /*@__PURE__*/ S.Array(
...
export const UpdateChatResponseMessageMetadataMap = /*@__PURE__*/ S.Record(
  S.String,
  S.Unknown,
) as any as S.Schema<UpdateChatResponseMessageMetadataMap>;

export interface UpdateChatResponseMessage {
  text: string;
  blocks?: unknown;
  attachments?: UpdateChatResponseMessageAttachmentsList;
  metadata?: UpdateChatResponseMessageMetadataMap;
}
export const UpdateChatResponseMessage = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    text: S.String,
    blocks: S.optional(S.Unknown),
    attachments: S.optional(UpdateChatResponseMessageAttachmentsList),
    metadata: S.optional(UpdateChatResponseMessageMetadataMap),
  }),
).annotate({
  identifier: "UpdateChatResponseMessage",
}) as any as S.Schema<UpdateChatResponseMessage>;
...
export const UpdateChatResponse = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ok: S.Boolean,
    channel: S.String,
    ts: S.String,
...
export type ChatUnfurlError = SlackOpError;
...
export const chatUnfurl: API.OperationMethod<
  ChatUnfurlRequest,
  ChatUnfurlResponse,
  ChatUnfurlError,
  SlackOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: ChatUnfurlRequest,
  output: ChatUnfurlResponse,
  errors: [SlackError, SlackRateLimited],
  protocol: SlackProtocol,
  retry: Retry.Retry,
}));
...
export type ListScheduledMessagesError = SlackOpError;
...
export const listScheduledMessages: API.PaginatedOperationMethod<
