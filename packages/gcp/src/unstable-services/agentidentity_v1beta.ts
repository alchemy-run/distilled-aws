...
export const CreateProjectsLocationsAuthProvidersRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "POST",
        uri: "v1beta/{+parent}/authProviders",
...
export const ListProjectsLocationsAccessSummariesRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "GET",
        uri: "v1beta/{+parent}/accessSummaries",
        baseUrl: "https://agentidentity.googleapis.com/",
      }),
    ),
  ).annotate({
...
export const ListProjectsLocationsAuthProvidersAuthorizationsRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "GET",
        uri: "v1beta/{+parent}/authorizations",
        baseUrl: "https://agentidentity.googleapis.com/",
      }),
    ),
  ).annotate({
...
export const QueryProjectsLocationsAuthProvidersRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "GET",
        uri: "v1beta/{+parent}/authProviders:query",
        baseUrl: "https://agentidentity.googleapis.com/",
      }),
    ),
  ).annotate({
...
export const QueryWorkloadsProjectsLocationsAuthProvidersRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "GET",
        uri: "v1beta/{+name}:queryWorkloads",
        baseUrl: "https://agentidentity.googleapis.com/",
      }),
    ),
  ).annotate({
...
export const RevokeAuthorizationProjectsLocationsAuthProvidersRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "POST",
        uri: "v1beta/{+name}:revokeAuthorization",
        baseUrl: "https://agentidentity.googleapis.com/",
      }),
    ),
  ).annotate({
