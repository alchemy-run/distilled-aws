...
export interface FlagNameList {
  /** Required. Flags to be rolled out. */
  flags?: StringList;
}
export const FlagNameList = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    flags: S.optional(StringList),
  }),
).annotate({ identifier: "FlagNameList" }) as any as S.Schema<FlagNameList>;
...
export const FlagRelease = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    flagNamesRelease: S.optional(FlagNameList),
