...
export const CreateProjectsLocationsMembershipsRbacrolebindingsRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "POST",
        uri: "v1/{+parent}/rbacrolebindings",
        baseUrl: "https://gkehub.googleapis.com/",
      }),
    ),
  ).annotate({
...
export const CreateProjectsLocationsRolloutSequencesRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "POST",
        uri: "v1/{+parent}/rolloutSequences",
        baseUrl: "https://gkehub.googleapis.com/",
      }),
    ),
  ).annotate({
...
export const ForceCompleteStageProjectsLocationsRolloutsRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "POST",
        uri: "v1/{+name}:forceCompleteStage",
        baseUrl: "https://gkehub.googleapis.com/",
      }),
    ),
  ).annotate({
...
export const GenerateConnectManifestProjectsLocationsMembershipsRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "GET",
        uri: "v1/{+name}:generateConnectManifest",
        baseUrl: "https://gkehub.googleapis.com/",
      }),
    ),
  ).annotate({
...
export const GenerateMembershipRBACRoleBindingYAMLProjectsLocationsMembershipsRbacrolebindingsRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "POST",
        uri: "v1/{+parent}/rbacrolebindings:generateMembershipRBACRoleBindingYAML",
        baseUrl: "https://gkehub.googleapis.com/",
      }),
    ),
  ).annotate({
...
export const ListMembershipsProjectsLocationsScopesRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "GET",
        uri: "v1/{+scopeName}:listMemberships",
        baseUrl: "https://gkehub.googleapis.com/",
      }),
    ),
  ).annotate({
...
export const ListPermittedProjectsLocationsScopesRequest =
  /*@__PURE__*/ S.suspend(() =>
    S.Struct({
      ...
      T.Http({
        method: "GET",
        uri: "v1/{+parent}/scopes:listPermitted",
        baseUrl: "https://gkehub.googleapis.com/",
      }),
    ),
  ).annotate({
