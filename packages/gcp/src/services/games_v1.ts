...
export interface GetTokensRecallRequest {
  /** Required. Opaque server-generated string that encodes all the necessary information to identify the PGS player / Google user and application. */
  sessionId: string;
}
export const GetTokensRecallRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    sessionId: S.String.pipe(T.Label()),
  }).pipe(
    T.Http({
  ...
  identifier: "GetTokensRecallRequest",
}) as any as S.Schema<GetTokensRecallRequest>;
...
export type GetTokensRecallError = NotFound | Forbidden | GcpOpError;
...
export const getTokensRecall: API.OperationMethod<
  GetTokensRecallRequest,
  RetrievePlayerTokensResponse,
  GetTokensRecallError,
  GcpOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetTokensRecallRequest,
