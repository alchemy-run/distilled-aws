...
export type UserListLicensePricingCostTypeEnum =
  ...
  | "CPM"
  | "MEDIA_SHARE";
export const UserListLicensePricingCostTypeEnum = S.String;
...
export const GetAccountTypesAccountsInsightsRequest = /*@__PURE__*/ S.suspend(
  () =>
    S.Struct({
      parent: S.String.pipe(T.Label()),
...
export type GetAccountTypesAccountsInsightsError =
  | NotFound
  | Forbidden
  | BadRequest
  | Conflict
...
export const getAccountTypesAccountsInsights: API.OperationMethod<
  ...
  GetAccountTypesAccountsInsightsError,
  GcpOpContext
> = /*@__PURE__*/ API.make(() => ({
  input: GetAccountTypesAccountsInsightsRequest,
