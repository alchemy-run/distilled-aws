...
export const CopyFilesRequest = /*@__PURE__*/ S.suspend(() =>
  S.Struct({
    ...
    copyComments: S.optional(S.Boolean.pipe(T.Query())),
...
export type GetAccessproposalsError = NotFound | Forbidden | GcpOpError;
...
export type GetApprovalsError = NotFound | Forbidden | GcpOpError;
...
export type ListAccessproposalsError = NotFound | Forbidden | GcpOpError;
...
export type ListApprovalsError = NotFound | Forbidden | GcpOpError;
